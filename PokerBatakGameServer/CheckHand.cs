...
namespace PokerBatakGameServer
{
    ...
    public class CheckHand
    {
        ...
        static int[] cardValue = new int[7];
        static int[] orginalCardValue = new int[7];
        public static PlayingPlayer _winnerPlayerDetails;
        public static int[] cards = new int[7];
        ...
        public static bool Kent()
        {
            ...
            else if (cardValue[3] == cardValue[4] - 1 && cardValue[3] == cardValue[5] - 2 && cardValue[3] == cardValue[6] + 3 && cardValue[6] == cardValue[0] + 9)
            {
                _winnerPlayerDetails.Hand = 4;
                _winnerPlayerDetails.HigherCard[0] = cardValue[0];
                return true;
